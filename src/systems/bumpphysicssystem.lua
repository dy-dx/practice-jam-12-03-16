-- mostly copied from https://github.com/bakpakin/tiny-ecs/blob/demo-commandokibbles/src/systems/BumpPhysicsSystem.lua
...
function BumpPhysicsSystem:onAdd(e)
    local pos = e.pos
    local hitbox = e.hitbox
    self.bumpWorld:add(e, pos.x+hitbox.x, pos.y+hitbox.y, hitbox.w, hitbox.h)
end
